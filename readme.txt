...
(FYI: Some of the dates for the commits is not correct since the clock 
in the virtual machine has been stopped during "save machine state" 
and therefore been put several days behind in some cases. 
However, the history for the merge pull requests should be okey.)
